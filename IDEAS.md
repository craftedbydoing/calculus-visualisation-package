...
- Divide nav panel more granular. e.g. Functions: plot, eps-delta def., continuity, eps-delta GAME,...; sequences: plot, eps-N def, eps-N GAME, Add pages: non-examples of continuity, etc
...
- Add: Continuity, derivative optimization idea
